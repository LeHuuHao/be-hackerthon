...
public class ExceptionController {
	...
	@ResponseStatus(code = HttpStatus.BAD_REQUEST)
	public ResponseDTO<Void> badInput(FeignException ex) {
		logger.error("err", ex);
		return ResponseDTO.<Void>builder().code(String.valueOf(HttpStatus.BAD_REQUEST.value())).message(HttpStatus.BAD_REQUEST.getReasonPhrase()).build();// view
	}
